...
public class C01_Cookies extends TestBaseBeforeAfter {
    ...
    public void test1() {
        ...
        Assert.assertFalse(tumCookie.contains(isim)); // tum cookie isim Cookie'sini icermiyor mu
        // Assert.assertFalse(tumCookie.contains("skin")); // bu olmuyore !!!
        //8-tum cookie’leri silin ve silindigini test edin
        driver.manage().deleteAllCookies();
        System.out.println("Tum cookieler silindi !");
        tumCookie = driver.manage().getCookies();
