...
{
    @Test
    public void test1() { // imlicitly wait extendde yorumda olması lazım
        ...
        WebElement enableButon = driver.findElement(By.xpath("//*[@onclick='swapInput()']"));
        enableButon.click();
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(15));
        wait.until(ExpectedConditions.elementToBeClickable(textBox)); //textBox elementi tıklanabilir olana kadar bekler
