...
public class C03_DropDown {
    ...
    */
    ...
    public void test1(){
    // Arama kutusunun yanindaki kategori menusundeki kategori sayisinin45
    // oldugunu testedin(yani 45 olmadıgını)
        WebElement ddm = driver.findElement(By.xpath("//*[@id='searchDropdownBox']"));
        Select select1 = new Select(ddm);
        int expectedNumber = 45;
        int actualNumber = select1.getOptions().size();
    ...
    public void test2(){
         ...
         */
        System.out.println(select.getFirstSelectedOption().getText()); //en son secilen ddm elemaninin adınıekrana yazdırır
        // 2.Arama kutusuna Java yazin vearatin
        driver.findElement(By.id("twotabsearchtextbox")).sendKeys("Java", Keys.ENTER);
        // 3.Bulunan sonuc sayisiniyazdirin
        WebElement sonucYazisi = driver.findElement(By.xpath("//*[@class='a-section a-spacing-small a-spacing-top-small'][1]"));
        System.out.println(sonucYazisi.getText());
        String [] sonucYazisiArr = sonucYazisi.getText().split(" "); // sonucYazisi kelime kelime sonucYazisiArr array'ine assign edildi
        String sonucSayisi = sonucYazisiArr[3];
