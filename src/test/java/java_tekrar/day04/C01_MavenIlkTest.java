...
public class C01_MavenIlkTest {
     ...
     */
        ...
        System.out.println("\"Samsung headphones\" aramasi sonucunda sonuc : " + sonucYazisiArr[2]);
        Thread.sleep(2000);
        // 5- Ilk urunu tiklayalim
        ...
        // System.out.println(driver.findElement(By.xpath("//h1")).getText()); //Hocaninki
